<footer class="footer bg-[#91A666] px-4 w-full h-60 flex justify-between" id="footer">
    <div class="contact pt-5 text-white">
        <h1 class="font-semibold mb-4">Hubungi Kami</h1>
        <div class="whatsapp flex items-center">
            <a href="">
            ...
            <a href="" class="text-xs ml-4">
                +62 881-2471-576
            </a>
        </div>
        <div class="email flex items-center my-4">
            <a href="">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
            ...
            <a href="" class="text-xs ml-4">
                piukidszone@gmail.com
            </a>
        </div>
        <div class="sosial-media flex mb-7">
            <a href="" class="mr-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
        ...
        <a href=""><img src="/img/logoPIUKIDS.png" alt=""></a>
    </div>
    <div class="shoping pt-5 text-white">
